...
urlpatterns = [
    ...
    path('', views.BoardListView.as_view(), name='home'), # con GCBV
    # path('boards/<int:pk>', views.board_topics, name='board_topics'), # normal y con FBV
    path('boards/<int:pk>', views.TopicListView.as_view(), name='board_topics'),
    path('boards/<int:pk>/new', views.new_topic, name='new_topic'),
    # path('boards/<int:pk>/topics/<int:topic_pk>', views.topic_posts, name='topic_posts'), # normal
    path('boards/<int:pk>/topics/<int:topic_pk>', views.PostListView.as_view(), name='topic_posts'),
    path('boards/<int:pk>/topics/<int:topic_pk>/reply', views.reply_topic, name='reply_topic'),
    # path('new_post', views.new_post, name='new_post'), línea comentada porque no se utiliza, ejemplo del tutorial
    # path('new_post', views.NewPostView.as_view(), name='new_post'), línea comentada porque no se utiliza, ejemplo del tutorial
    ...
    path('reset/<slug:uidb64>/<slug:token>/', auth_views.PasswordResetConfirmView.as_view(template_name='password_reset_confirm.html'), name='password_reset_confirm'),
